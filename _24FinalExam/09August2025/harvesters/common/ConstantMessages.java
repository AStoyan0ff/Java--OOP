...
public class ConstantMessages {
    ...
    public static final String HARVESTER_ADDED =
            "%s %s added.";

    public static final String HARVESTING_FIELD =
            "There was harvesters at %s %s. Remaining crops: %d";

    public static final String NO_MORE_CROPS =
